...
BrowerRouter is a parent component which allows to wrap the application route. Using the BrowserRouter we can access the browser history. Sometimes it can be renamed as router.
...
const challenges = [
  {
    ...
    description:
      'It is is a step by step guide to learn React',
    status: 'completed',
    days: 300,
    level: 'Beginners to Advanced',
    duration: '20 Jan 20 May 2023',
    slug: 'react',
    url:
