...
Other HTML fields to get data from a form are textarea and select with options elements.
...
const App = () => {
  ...
  return (
    <div className='App'>
    // associate a label with a form input element.
...
1. Validate the form given above. First try to validate without using any library then try it with [validator.js](https://www.npmjs.com/package/validator).